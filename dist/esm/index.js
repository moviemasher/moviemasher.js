...
class TransitionClass extends TransitionWithVisible {
    constructor(...args) {
        ...
        this.fromTrack = 0;
        this.toTrack = 1;
        this.trackType = TrackType.Transition;
        const [object] = args;
...
class TransitionDefinitionClass extends TransitionDefinitionWithVisible {
    constructor(...args) {
        ...
        this.properties.push(new Property({ name: "fromTrack", type: DataType.Number, value: 0 }), new Property({ name: "toTrack", type: DataType.Number, value: 1 }));
        Definitions.install(this);
    }
...
class MasherClass {
    ...
    can(method) {
        ...
        switch (method) {
            ...
            case MasherAction.Remove: return !!(effect
                || clip
            ...
            case MasherAction.Freeze: return (!!clip
