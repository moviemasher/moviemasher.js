...
function mm_load() {
  console.log("MovieMasher", MovieMasher);
    
  var canvas = document.getElementById('mm-canvas');
  if (canvas && MovieMasher && MovieMasher.MovieMasher.supported) {
    mm_player = MovieMasher.MovieMasher.player();
    // console.log("mm_player", mm_player);
    // register the filters we use
    // MovieMasher.Registry.register("filter", [
    ...
    // MovieMasher.Registry.register("font", {
