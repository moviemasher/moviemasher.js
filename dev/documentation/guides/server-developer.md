...
The [@moviemasher/lib-server](https://www.npmjs.com/package/@moviemasher/lib-server)
...
The server package is optimized to work with the [@moviemasher/lib-client](https://www.npmjs.com/package/@moviemasher/lib-client) package, but this is not a requirement. 
...
```javascript
const MovieMasherServer = require("@moviemasher/lib-server")
