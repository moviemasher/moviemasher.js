...
AV_DEPENDENCIES='harfbuzz-devel libjpeg-devel libwebp-devel libzstd-devel jbigkit-devel openjpeg2 openjpeg2-devel opus fontconfig-devel freetype-devel fribidi-devel libogg-devel libsndfile-devel speex-devel librsvg2 librsvg2-devel librsvg2-tools libtheora-devel libvorbis-devel' ;
ENABLE='--enable-libass --enable-libharfbuzz --enable-libfribidi --enable-libfreetype --enable-libfontconfig --enable-gpl --enable-nonfree --enable-version3 --enable-libopenjpeg --enable-librsvg --enable-libx264 --enable-libfdk_aac --enable-libmp3lame --enable-libvpx  --enable-libspeex --enable-libtheora --enable-libvorbis  --enable-zlib --enable-libopus --enable-postproc --enable-pthreads --enable-swresample'
