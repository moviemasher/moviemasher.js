...
```javascript
const MovieMasherServer = require("@moviemasher/server-lib")
...
You should be able to switch the port to 5775 and execute this script by whatever means you typically launch ExpressJS applications. Even without a custom FFmpeg build you should be able do everything short of rendering video files. 
