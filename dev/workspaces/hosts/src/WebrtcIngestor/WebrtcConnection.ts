...
import { Command, CommandInputOptions, OutputOptions } from '../Command/Command'
...
class WebrtcConnection extends EventEmitter {
  ...
  streamForDimensions(width: number, height: number): WebrtcStream {
    ...
    const command = Command.create(this.id, {
  ...
  static async create(id: string, outputPrefix?: string, outputOptions?: OutputOptions): Promise<WebrtcConnection> {
