...
type UnknownRecords = UnknownRecord[];
...
type PathDataOrError = DefiniteError | PathData;
...
declare const RecordType: RecordType;
type RecordsType = "records";
declare const RecordsType: RecordsType;
type MediaType = AudioType | EffectType | FontType | ImageType | MashType | SequenceType | VideoType;
type MediaTypes = MediaType[];
declare const MediaTypes: MediaTypes;
type MediaTypesRecord = Record<string, MediaTypes>;
...
type TranscodingType = AudioType | FontType | ImageType | VideoType | SequenceType;
declare const TranscodingTypes: MediaTypes;
declare const isTranscodingType: (type?: any) => type is TranscodingType;
declare function assertTranscodingType(value: any, name?: string): asserts value is TranscodingType;
...
type LoadType = string | RawType | FontType | RecordType | RecordsType;
type LoadTypes = LoadType[];
declare const LoadTypes: LoadTypes;
declare const isLoadType: (type?: any) => type is string;
...
type EncodingType = AudioType | ImageType | VideoType | FontType | SequenceType;
declare const EncodingTypes: EncodingType[];
...
declare const OrderAscending = "acending";
declare const OrderDecending = "decending";
declare const ExtJpeg = "jpg";
declare const JsonExtension = "json";
declare const TextExtension = "txt";
declare const CssExtension = "css";
declare const Mp4Extension = "mp4";
declare const PngExtension = "png";
declare const CssContentType = "text/css";
...
declare const isLoaderType: (value: any) => value is string;
 ...
 * @category Plugin
 */
interface Plugin extends UnknownRecord {
    type: PluginType;
}
interface PluginRecord extends Record<string, Plugin> {
}
type DecodeType = "decode";
declare const DecodeType: DecodeType;
type EncodeType = "encode";
declare const EncodeType: EncodeType;
type TranscodeType = "transcode";
declare const TranscodeType: TranscodeType;
type ProtocolType = "protocol";
declare const ProtocolType: ProtocolType;
type LanguageType = "language";
declare const LanguageType: LanguageType;
type FilterType = "filter";
declare const FilterType: FilterType;
type ResolveType = "resolve";
declare const ResolveType: ResolveType;
type ProtocolTypes = ProtocolType[];
type PluginType = string | ProtocolType | ResolveType | DecodeType | EncodeType | TranscodeType | FilterType | LanguageType;
interface Probing extends Decoding {
    type: ProbeType;
    data: ProbingData;
}
interface ProbingData extends UnknownRecord {
    audible?: boolean;
    duration?: number;
    family?: string;
    extension?: string;
...
type DecodingType = string | ProbeType;
type DecodingTypes = DecodingType[];
declare const DecodingTypes: DecodingTypes;
declare const isDecodingType: (value: any) => value is string;
interface DecoderOptions {
}
interface DecodeData extends Data {
    data: Decoding;
}
type DecodeDataOrError = DefiniteError | DecodeData;
type DecodeMethod = (localPath: string, options?: DecoderOptions) => Promise<PathDataOrError>;
/**
 * @category Plugin
 */
interface DecodePlugin extends Plugin {
    type: DecodingType;
    decode: DecodeMethod;
}
/**
 * @category Plugin
 */
interface PluginsByDecoder extends Record<DecodingType, DecodePlugin> {
}
interface ProbeData extends Data {
    data: ProbingData;
}
...
interface Decoding extends Partial<Identified> {
    type: DecodingType;
    data?: UnknownRecord;
}
...
declare function assertEndpoint(value: any, name?: string): asserts value is Endpoint;
...
declare const HttpProtocol: HttpProtocol;
type HttpsProtocol = "https";
declare const HttpsProtocol: HttpsProtocol;
type BlobProtocol = "blob";
declare const BlobProtocol: BlobProtocol;
type FileProtocol = "file";
declare const FileProtocol: FileProtocol;
type Protocol = string | HttpProtocol | HttpsProtocol | BlobProtocol | FileProtocol;
/**
 * @category Plugin
 */
...
declare const requestAudioPromise: (request: Request) => Promise<AudioDataOrError>;
declare const requestFontPromise: (request: Request) => Promise<FontDataOrError>;
declare const requestImagePromise: (request: Request) => Promise<ImageDataOrError>;
declare const requestProtocolPromise: (request: Request) => Promise<ProtocolPlugin>;
declare const requestVideoPromise: (request: Request) => Promise<VideoDataOrError>;
declare const requestRecordPromise: (request: Request, useResponse?: boolean) => Promise<RecordDataOrError>;
declare const requestRecordsPromise: (request: Request, useResponse?: boolean) => Promise<RecordsDataOrError>;
declare const requestRawPromise: (request: Request, type: RawType) => Promise<MediaDataOrError>;
declare const requestMediaPromise: (request: Request, type: LoadType) => Promise<MediaDataOrError>;
declare const requestPromise: (request: Request, type?: string) => Promise<PathDataOrError>;
...
declare class MashMediaClass extends MediaBase implements MashMedia {
    ...
    private _loadMashContentPromise?;
    private _loadedMashContent;
    private get loadMashContentPromise();
...
declare const mashDefault: MashMediaObject;
declare const mashMedia: (object: MashMediaObject, args?: MashEditorArgs | Size) => MashMedia;
...
type ClientMedia = ClientImage | ClientVideo | ClientAudio | ClientFont;
...
interface VideoData extends Data {
    data: ClientVideo;
}
...
interface FontData extends Data {
    data: ClientFont;
}
interface EffectData extends Data {
    data: ClientEffect;
}
interface MashData extends Data {
    data: ClientMash;
}
interface RecordData extends Data {
    data: JsonRecord;
}
interface RecordsData extends Data {
    data: JsonRecords;
}
type MediaData = ImageData | VideoData | AudioData | FontData;
type ImageDataOrError = DefiniteError | ImageData;
type AudioDataOrError = DefiniteError | AudioData;
type VideoDataOrError = DefiniteError | VideoData;
type FontDataOrError = DefiniteError | FontData;
type MediaDataOrError = ImageDataOrError | AudioDataOrError | VideoDataOrError | FontDataOrError;
type EffectDataOrError = DefiniteError | EffectData;
type MashDataOrError = DefiniteError | MashData;
type RecordDataOrError = DefiniteError | RecordData;
type RecordsDataOrError = DefiniteError | RecordsData;
...
interface MashMediaContent {
    color?: string;
    quantize?: Number;
    tracks?: TrackObject[];
    media?: MediaObjects;
}
interface MashMediaRequest extends Request {
...
declare const isPlugin: (value: any) => value is Plugin;
declare function assertPlugin(value: any, name?: string): asserts value is Plugin;
declare const pluginId: (id: string) => string;
declare const plugin: (pluginType: PluginType, id: string) => Plugin;
declare const pluginPromise: (pluginType: PluginType, id: string) => Promise<Plugin>;
interface Plugins extends Record<PluginType, PluginRecord> {
}
...
declare const isProbing: (value: any) => value is Probing;
declare function assertProbing(value: any): asserts value is Probing;
...
declare const resolverPathPromise: (file: string, mimeType?: string) => PathDataOrError | Promise<PathDataOrError>;
...
declare const arrayLast: (array: Unknowns) => any;
declare const arraySet: (array: Unknowns, items: Unknowns) => Unknowns;
declare const arrayReversed: (array: Unknowns) => unknown[];
declare const arrayUnique: (array: Unknowns) => unknown[];
...
declare const mediaInfo: (media?: ClientMedia) => ProbingData;
...
declare const isMethod: (value: any) => value is UnknownMethod;
declare function assertMethod(value: any, name?: string): asserts value is UnknownMethod;
...
declare const isArray: (value: any) => value is Unknowns;
declare function assertArray(value: any, name?: string): asserts value is Unknowns;
...
declare const isPopulatedArray: (value: any) => value is Unknowns;
declare function assertPopulatedArray(value: any, name?: string): asserts value is Unknowns;
...
declare const isJsonRecords: (value: any) => value is JsonRecords;
declare const isDefiniteError: (value: any) => value is DefiniteError;
