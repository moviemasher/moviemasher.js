...
import PluginTranslateIdentifierJson from './locale/en.json'

const LocaleIdentifier: Locale = 'en'

class PluginTranslateIdentifier implements TranslatePlugin {
  ...
  private words: NestedStringRecord = PluginTranslateIdentifierJson
...
Runtime.plugins[TranslateType][LocaleIdentifier] = new PluginTranslateIdentifier()