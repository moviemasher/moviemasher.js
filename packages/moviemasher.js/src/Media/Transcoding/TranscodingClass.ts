...
import { assertDefinitionType, assertLoadType, assertMediaDefinitionType, DefinitionType, LoadType, MediaDefinitionType } from "../../Setup/Enums";
...
export class TranscodingClass extends RequestableClass implements Transcoding {
  ...
  get loadType(): LoadType { 
    ...
    if (type === DefinitionType.VideoSequence) return LoadType.Image
