...
import PluginTranslateEnglishJson from './locale/en.json'

const LocaleEnglish: Locale = 'en'

class PluginTranslateEnglish implements TranslatePlugin {
  ...
  private words: NestedStringRecord = PluginTranslateEnglishJson
...
Runtime.plugins[TranslateType][LocaleEnglish] = new PluginTranslateEnglish()