...
import { DefaultInputs } from '../Editor/EditorInputs/DefaultInputs/DefaultInputs'
...
interface MasherDefaultsOptions extends EditorDefaultsArgs, PropsWithoutChild {}

const MasherDefaults: PropsMethod<MasherDefaultsOptions, MasherProps> = function(options) {
  ...
  const playerNode = (panelOptions: PanelOptionsStrict) => {
    ...
    panelOptions.header.content ||= [ <img key='logo' src="img/mm.svg" />]
  ...
  return { className: classNameEditor, mash, children, inputs: inputs || DefaultInputs }
}
export { MasherDefaults, MasherDefaultsOptions, ContentOptions, UiOptions, PanelOptionsStrict, PanelOptions, PanelOptionsOrFalse }
