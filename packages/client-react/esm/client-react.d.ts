...
import { ActivityInfo, AndId, Endpoint, ApiServersResponse, JsonObject, StringSetter, Definition, DefinitionType, Clip, DroppingPosition, Layer, VoidMethod, DefinitionObject, UnknownObject, MashAndDefinitionsObject, Effect, Point, Rect, DataType, DataGroup, SelectType, SelectedEffects, Scalar, PropertiedChangeHandler, Property, Time, SelectedItems, TimeRange, EffectRemovehandler, Size, EditType, DataDefaultResponse, Editor, EditorIndex, BooleanSetter, NumberSetter, ServerType, Track, EndpointPromiser, Emitter, EventType, StringObject } from "@moviemasher/moviemasher.js";
...
declare function SelectEditedControl(props: PropsWithoutChild): ReactResult;
