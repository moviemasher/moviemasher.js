import { MediaType, isMediaType, isSelectorType, isString, Properties, SelectorType, CommaChar } from "@moviemasher/lib-core"

const propsStringArray = (string?: string, array?: string | string[], properties?: Properties): string[] => {
