...
import { 
  RenderingOutput, RenderingOutputArgs, isUpdatableDurationDefinition, AVType, 
  RenderingCommandOutput, Clip, isPositive, IntrinsicOptions, Time, GraphFiles, 
  FilterGraphsOptions, GraphType, Clips, PreloadArgs, EmptyMethod, Size, Errors, 
  OutputType, RenderingResult, RenderingDescription, CommandDescription, 
...
export class RenderingOutputClass implements RenderingOutput {
  ...
  get filterGraphs() {
    return this.args.mash.filterGraphs(this.filterGraphsOptions)
  }
