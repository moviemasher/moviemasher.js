import type { DataOrError, JobProduct } from '@moviemasher/runtime-shared'

import { DOT, JSON, isIdentified, isTyped } from '@moviemasher/runtime-shared'
import { ERROR, isDefiniteError, jsonParse, namedError } from '@moviemasher/runtime-shared'
