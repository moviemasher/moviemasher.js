...
import { 
  IMAGE, EncodeTypeVideo, PROBE, VIDEO
} from "@moviemasher/runtime-shared"

import { Environment, environment, RenderingOutputClass, outputDefaultPopulate } from '@moviemasher/lib-server'
...
describe("Job", () => {
  ...
  test("renderingDescriptionPromise", async () => {
    ...
    const globeDefinitionObject = {
      id: 'image-id-globe', type: IMAGE, source: '../shared/image/globe.jpg',
      decodings: [{ type: PROBE, data: { width: 320, height: 320 } }]
    }
    const cableDefinitionObject = {
      id: 'image-id-cable', type: IMAGE, source: '../shared/image/cable.jpg',
      decodings: [{ type: PROBE, data: { width: 320, height: 240 } }]
    }
