import type {CommandFiles, CommandFilterArgs, CommandFilters, FilterCommandFileArgs, FilterCommandFilterArgs, VisibleCommandFileArgs} from '../Server/GraphFile.js'
import type {Effect, EffectMedia} from './Effect.js'
...
import {assertPopulatedString, isTimeRange} from '../Shared/SharedGuards.js'
import { assertProperty } from '../Setup/PropertyFunctions.js'
import { PropertyTweenSuffix } from '../Base/PropertiedConstants.js'
import { TypeEffect, TypeNone, ActionTypeChange } from '../Setup/EnumConstantsAndFunctions.js'
...
export class EffectClass extends PropertiedClass implements Effect {
  id = ''
  label?: string 
  get assetIds(): string[] { return this.definition.assetIds }
