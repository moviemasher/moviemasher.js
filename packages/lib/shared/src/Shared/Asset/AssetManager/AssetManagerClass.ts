...
import { isArray } from '../../SharedGuards.js'
...
export class AssetManagerClass implements AssetManager {
  ...
  fromId(id: string): Asset {
    ...
    if (this.predefined(id)) return this.predefinedAssets.get(id)!
  ...
  predefine(id: string, asset: Asset): void {
    this.predefinedAssets.set(id, asset)
  }

  private predefined(id: string) {
    return this.predefinedAssets.has(id)
  ...
  private predefinedAssets: Map<string, Asset> = new Map()
