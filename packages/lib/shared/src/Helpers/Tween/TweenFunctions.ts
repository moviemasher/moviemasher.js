import type { Instance, Lock, NumberRecord, Point, PointTuple, PopulatedString, Rect, RectTuple, Scalar, SideDirectionObject, Size, SizeTuple, Time, TimeRange, Value } from '@moviemasher/runtime-shared'

import { isArray, isDefined, isNumber, isObject, isPopulatedString } from '@moviemasher/runtime-shared'
import { LockHeight, LockWidth } from '../../Setup/LockConstants.js'
...
import { assertSize, isSize, sizeCeil, sizeCover, sizeLock, sizeScale, sizesEqual } from '../../Utility/SizeFunctions.js'
import { colorMixRbg, colorMixRbga, colorRgbToHex, colorRgbaToHex, colorToRgb, colorToRgba, colorValidHex } from '../Color/ColorFunctions.js'
