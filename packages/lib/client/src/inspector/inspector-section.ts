...
export class InspectorSectionElement extends Section {
  override divContent(htmls: Htmls): OptionalContent {
    this.importTags('movie-masher-inspector-div')
    return html`<movie-masher-inspector-div
      part='div' 
    >${htmls}</movie-masher-inspector-div>`
  }
...
customElements.define('movie-masher-inspector-section', InspectorSectionElement)
