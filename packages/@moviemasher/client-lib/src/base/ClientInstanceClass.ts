...
import type { ChangeEditObject, Directions, InstanceArgs, Property, PropertyId, SizeKey, Scalar, TargetId } from '@moviemasher/shared-lib/types.js'
...
export class ClientInstanceClass extends InstanceClass implements ClientInstance {
  ...
  private shouldSelectPropertySize(sizeKey: SizeKey): boolean {
    ...
    // console.log(this.constructor.name, 'shouldSelectPropertySize', {mashPortrait, flipped, size, property, SizeKey})
