import type { ClientAudibleInstance, ClientVisibleInstance } from '@moviemasher/shared-lib/types.js'

import { errorThrow } from '@moviemasher/shared-lib/runtime.js'
import { isAudibleInstance, isInstance, isVisibleInstance } from '@moviemasher/shared-lib/utility/guards.js'
import { isClientAsset } from '../runtime.js'
import { ClientInstance } from '@moviemasher/shared-lib/types.js'
