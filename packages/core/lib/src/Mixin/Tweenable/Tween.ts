import type { NumberRecord, PopulatedString, Scalar, Value } from '../../Types/Core.js'
...
import { assertRect, isRect } from '../../Utility/Rect.js'
import { assertSize, sizeCeil, sizeScale, isSize, sizeCover, sizesEqual, sizeLock } from '../../Utility/Size.js'
