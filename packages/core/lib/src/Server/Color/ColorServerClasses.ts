...
import { ColorAsset, ColorInstance, ColorInstanceObject } from '../../Shared/Color/ColorTypes.js'
...
export class ServerColorAssetClass extends WithColorAsset implements ColorAsset {
...
export class ServerColorInstanceClass extends WithColorInstance implements ColorInstance { 
  ...
  //   super(args)
  // }
  // declare asset: ColorAsset & ServerAsset
