...
import type {CommandFile, CommandFileArgs, CommandFiles, CommandFilter, CommandFilterArgs, CommandFilters, FilterCommandFilterArgs, VisibleCommandFileArgs, VisibleCommandFilterArgs} from '../../Base/Code.js'

import {colorBlack, colorBlackOpaque, colorWhite} from '../../Helpers/Color/ColorConstants.js'
import { sizeEven, sizesEqual } from "../../Utility/SizeFunctions.js"
import {assertPopulatedArray, assertPopulatedString, isBoolean, isPopulatedArray, isPopulatedString, isTimeRange} from '../../Shared/SharedGuards.js'
...
import { GraphFileTypeSvg } from '../../Setup/EnumConstantsAndFunctions.js'
import { ValueRecord } from '@moviemasher/runtime-shared'
import { PointZero } from '../../Utility/PointConstants.js'
import { svgTransform } from '../../Helpers/Svg/SvgFunctions.js'
import { NamespaceSvg } from '../../Setup/Constants.js'
import { rectsEqual } from '../../Utility/RectFunctions.js'
import { ShapeAsset, ShapeInstance, ShapeInstanceObject } from '../../Shared/Shape/ShapeTypes.js'
...
export class ServerShapeAssetClass extends WithShapeAsset implements ShapeAsset {
...
export class ServerShapeInstanceClass extends WithShapeInstance implements ImageInstance { 
  constructor(args: ShapeInstanceObject & InstanceArgs) {
    super(args)
  }
  declare asset: ShapeAsset & ServerAsset
