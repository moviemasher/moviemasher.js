import {Scalar, UnknownRecord} from '@moviemasher/runtime-shared'
import { ActionTypeChange, DurationNone, DurationUnknown, DurationUnlimited, TypeTrack } from "../../../Setup/EnumConstantsAndFunctions.js"
...
import {assertPopulatedString, assertTrue, isAboveZero, isDefined, isPositive} from '../../SharedGuards.js'
...
import {arrayLast, arraySet} from '../../../Utility/ArrayFunctions.js'
import { ChangePropertyActionObject } from "../../../Plugin/Masher/Actions/Action/Action.js"
import { MashAsset } from '../MashTypes.js'
import { ClientClips, ClientTrack, MashClientAsset } from '../../../Client/Mash/MashClientTypes.js'
  ...
  constructor(args: TrackArgs) {
    ...
    if (clips) {
      this.clips.push(...clips.map(clip => {
        ...
        console.log(this.constructor.name, 'clipInstance setting track', instance.constructor.name)
        instance.track = this
        return instance
      }))
    }
