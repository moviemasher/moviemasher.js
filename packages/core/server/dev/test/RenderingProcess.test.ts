...
import { SizePreview, assertPopulatedArray, outputOptions, TypeVideo } from "@moviemasher/lib-core"

import { renderingTestIdPromise, renderingJobPromise } from '../../../../../images/tester/Utilities/Rendering'
...
describe("RenderingProcess", () => {
  ...
  const testIdPromise = async (id) => {
    const videoOutput = outputOptions(TypeVideo, { ...SizePreview, mute: true }) 
