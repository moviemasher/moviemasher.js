...
import { Any, OutputObject, outputHls } from '@moviemasher/moviemasher.js'
...
class WebrtcConnection extends EventEmitter {
  constructor(id: string, outputPrefix?: string, outputOptions?: OutputObject) {
    super()
    this.id = id
    this.state = 'open'
  ...
  outputOptions: OutputObject = outputHls()
  ...
  static async create(id: string, outputPrefix?: string, outputOptions?: OutputObject): Promise<WebrtcConnection> {
