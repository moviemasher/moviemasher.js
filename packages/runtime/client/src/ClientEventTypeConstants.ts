...
export const EventTypeResize = 'resize'
...
export const EventTypeDialog = 'dialog'
...
export const EventTypeAssetObjects = 'asset-objects'
export const EventTypeAssetObject = 'asset-object'
export const EventTypeAssetObjectFromId = 'asset-object-from-id'

export const EventTypeSelectAssetObject = 'select-asset-object'
