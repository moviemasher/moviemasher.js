...
export type ActionType = AddClipActionType | AddTrackActionType | ChangeActionType | ChangeFrameActionType | ChangeMultipleActionType | MoveClipActionType | RemoveClipActionType
